...
<table>
  ...
  <tr>
    ...
    <td> Adds a watermark to the local video canvas (deprecated). The method is only supported on Windows. </td>
    <td>V4.2.0</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> Adds a watermark to the remote video canvas (deprecated). The method is only supported on Windows. </td>
    <td>V4.2.0</td>
  </tr>
</table>
