...
/**
 ...
 - 房间服务相关错误码：{@link nertc::NERtcRoomServerErrorCode}
 - 混音相关错误码：{@link nertc::NERtcAudioMixingErrorCode}
 - 音视频设备相关错误码：{@link nertc::NERtcDMErrorCode}
...
<table>
  ...
  <tr>
    ...
    <td>（此接口已废弃）添加本地视频画布水印。仅支持 Windows 平台。</td>
    <td>V4.2.0</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>（此接口已废弃）添加远端视频画布水印。仅支持 Windows 平台。</td>
    <td>V4.2.0</td>
  </tr>
</table>
