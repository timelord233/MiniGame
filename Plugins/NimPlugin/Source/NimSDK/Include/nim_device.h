...
/** @fn void nim_vchat_start_device(enum NIMDeviceType type,
...
/** @fn void nim_vchat_enum_device_devpath(enum NIMDeviceType type,
                                           const char* json_extension,
...
/** @fn bool nim_vchat_accompanying_sound(unsigned char id,
                                          uint64_t time,
                                          const char* data,
                                          unsigned int size,
                                          unsigned int rate,
...
/** @fn void nim_vchat_start_extend_camera(const char* id,
                                           const char* device_path,
                                           uint32_t fps,
                                           const char* json_extension,
                                           nim_vchat_start_device_cb_func cb,
...
/** @fn void nim_vchat_preload_effect(int id,
                                      const char* path,
                                      const char* json_extension,
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_vchat_preload_effect(int id,
                                              const char* path,
                                              const char* json_extension,
                                              nim_vchat_audio_effect_opt_cb_func cb,
                                              const void* user_data);
 ...
 * @return void 无返回值
 */
NIM_SDK_DLL_API void nim_vchat_play_effect(int id,
                                           int loop_count,
                                           const char* json_extension,
                                           nim_vchat_audio_effect_opt_cb_func cb,
                                           const void* user_data);
